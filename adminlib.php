      ...
      VALUES (NULL,'$libname','$libemail','$libalias','$participant','$suspend','$system','$phone','$address1','$address2','$address3','$loc','$oclc','$book','$journal','$av','$ebook','$ejournal','$reference','$timestamp')";
        ...
        ?>
            <form action="" .$_SERVER['REDIRECT_URL']."?<?php echo $_SERVER['QUERY_STRING']; ?>" method="post">
                ...
                <B>Library ILL participant</b><select name="participant">
                    <option value="1">Yes</option>
                    <option value="0">No</option>
                </select><br>
                <B>Suspend ILL</b><select name="suspend">
                    <option value="0">No</option>
                    <option value="1">Yes</option>
                </select><br>
                <B>Library System</b><select name="system">
                ...
                <table>
                    ...
                    <tr>
                        <td><b>Public Library System Courier (MHLS or RCLS)</b>
                        <td>
                    ...
                    <tr>
                        <td><b>Commercial Courier (UPS or FEDEX)</b>
                        <td>
                ...
                <table>
                    ...
                    <tr>
                        <td><b>Print Journal or Article</b>
                        <td>
        ...
        <?php
            ...
            <form action="/adminlib?<?php echo $_SERVER['QUERY_STRING']; ?>" method="post">
                ...
                <B>Library Email Alert</b><select name="$libemailalert">
                    <option value="1" <?php if ($libemailalert == "1") {
                                                                                                                    echo "selected=\"selected\"";
                                                                                                                } ?>>Yes</option>
                    <option value="0" <?php if ($libemailalert == "0") {
                                                                                                                    echo "selected=\"selected\"";
                                                                                                                } ?>>No</option>
                </select><br>
                <B>Library ILLiad</b><select name="libilliad">
                    <option value="1" <?php if ($libilliad == "1") {
                                                                                                                    echo "selected=\"selected\"";
                                                                                                                } ?>>Yes</option>
                    <option value="0" <?php if ($libilliad == "0") {
                                                                                                                    echo "selected=\"selected\"";
                                                                                                                } ?>>No</option>
                </select><br>
                ...
                <B>Library ILL participant</b><select name="participant">
                    <option value="1" <?php if ($libparticipant == "1") {
                                                                                                                    echo "selected=\"selected\"";
                                                                                                                } ?>>Yes</option>
                    <option value="0" <?php if ($libparticipant == "0") {
                                                                                                                    echo "selected=\"selected\"";
                                                                                                                } ?>>No</option>
                </select><br>
                <B>Suspend ILL</b><select name="suspend">
