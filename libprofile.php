   ...
   <?php if ($system=="DU") {
    ...
    <B>Library System:</b> <?php echo $system?><br>
     ...
     <B>Suspend Your Library's lending status?   </b><select name="suspend">  <option value="0" <?php if ($libsuspend=="0") {
             ...
             echo "selected=\"selected\"";
         } ?>>Yes</option></select><br>&nbsp&nbsp&nbsp&nbspSetting this to <strong>YES</strong> will <strong>prevent</strong> your library getting ILL requests<br>&nbsp&nbsp&nbsp&nbspSetting this to <strong>NO</strong> will <strong>allow</strong> your library to receive ILL requests.<br>
 Suspension End Date:
