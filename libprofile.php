...
mysqli_select_db($db,$dbname);
 ...
 if ($_SERVER['REQUEST_METHOD'] == 'POST'){
       ...
       $sqlupdate = "UPDATE `$sealLIB` SET Name = '$libname',  `ILL Email` ='$libemail',suspend=$suspend,phone='$phone',address1='$address1',address2='$address2',address3='$address3',oclc='$oclc',book='$book',journal='$journal',av='$av',ebook='$ebook',reference='$reference',SuspendDateEnd='$enddated',ModifyDate='$timestamp', ModEmail='$lastmodemail'  WHERE `loc` ='$loc'";
       #echo $sqlupdate;
