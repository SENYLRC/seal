...
while ($row = mysqli_fetch_assoc($retval)) {
    ...
    ###Get the Destination
    $GETLISTSQLDESTEMAIL = "SELECT `ill_email` FROM `$sealLIB` where loc LIKE '$destination'  limit 1";
...
<br>
This is an automated message from the SEAL ILL System. Responses to this email will be sent back to staff at Southeastern New York Library Resources Council. If you would like to contact the
 other library in t
...
<br>";
        ...
        $email_to = implode(',', $destemailarray);
        $headers = "From: SEAL <dontreply@senylrc.org>\r\n";
        ...
        $sqlupdate = "UPDATE `$sealSTAT` SET `emailsent` = '2' , `responderNOTE` =  'REMINDER MSG Sent' WHERE `illNUB` = '$illnum'";
